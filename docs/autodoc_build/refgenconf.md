...
```python
def get_asset_table(self, genomes=None, server_url=None, get_json_url=<function RefGenConf.<lambda> at 0x7fe3a1bbba60>)
```
...
```python
def get_remote_data_str(self, genome=None, order=None, get_url=<function RefGenConf.<lambda> at 0x7fe3a1bbd598>)
```
...
```python
def listr(self, genome=None, order=None, get_url=<function RefGenConf.<lambda> at 0x7fe3a1bbd6a8>, as_str=False)
```
...
```python
def pull(self, genome, asset, tag, unpack=True, force=None, force_large=None, size_cutoff=10, get_json_url=<function RefGenConf.<lambda> at 0x7fe3a1bbd950>, build_signal_handler=<function _handle_sigint at 0x7fe3a12d5b70>)
```
...
```python
def seek(self, genome_name, asset_name, tag_name=None, seek_key=None, strict_exists=None, enclosing_dir=False, all_aliases=False, check_exist=<function RefGenConf.<lambda> at 0x7fe3a1bbd0d0>)
```
...
```python
def seek_src(self, genome_name, asset_name, tag_name=None, seek_key=None, strict_exists=None, enclosing_dir=False, check_exist=<function RefGenConf.<lambda> at 0x7fe3a1bbd1e0>)
```
...
```python
def set_genome_alias(self, genome, digest=None, servers=None, overwrite=False, reset_digest=False, create_genome=False, no_write=False, get_json_url=<function RefGenConf.<lambda> at 0x7fe3a1bbdbf8>)
```
...
```python
def upgrade_config(target_version, filepath, force=False, get_json_url=<function <lambda> at 0x7fe3a1bbb510>, link_fun=<function <lambda> at 0x7fe3a1bbee18>)
```
