...
```python
def get_remote_data_str(self, genome=None, order=None, get_url=<function RefGenConf.<lambda> at 0x7f14d6d19050>)
```
...
```python
def listr(self, genome=None, order=None, get_url=<function RefGenConf.<lambda> at 0x7f14d6d19170>)
```
...
```python
def pull(self, genome, asset, tag, unpack=True, force=None, get_json_url=<function RefGenConf.<lambda> at 0x7f14d6d19440>, build_signal_handler=<function _handle_sigint at 0x7f14a13389e0>)
```
...
```python
def seek(self, genome_name, asset_name, tag_name=None, seek_key=None, strict_exists=None, enclosing_dir=False, check_exist=<function RefGenConf.<lambda> at 0x7f14d6d13c20>)
```
