...
```python
def get_remote_data_str(self, genome=None, order=None, get_url=<function RefGenConf.<lambda> at 0x7f6f6a5b8f80>)
```
...
```python
def listr(self, genome=None, order=None, get_url=<function RefGenConf.<lambda> at 0x7f6f6a5bd0e0>)
```
...
```python
def pull(self, genome, asset, tag, unpack=True, force=None, get_json_url=<function RefGenConf.<lambda> at 0x7f6f6a5bd3b0>, build_signal_handler=<function _handle_sigint at 0x7f6f34be0950>)
```
...
```python
def seek(self, genome_name, asset_name, tag_name=None, seek_key=None, strict_exists=None, enclosing_dir=False, check_exist=<function RefGenConf.<lambda> at 0x7f6f6a5b8b90>)
```
