...
asset_build_packages = {
    ...
    "ensembl_gtf": {
        "description": "Given a Ensembl GTF file (must be downloaded), create Ensembl GTF, TSS, and gene body annotation assets.",
        "required_inputs": ["gtf"],
        "required_assets": [],
        "container": "databio/refgenie",
        "assets": {
            "ensembl_gtf": "ensembl_gtf/{genome}.gtf.gz",
            "ensembl_tss": "ensembl_gtf/{genome}_ensembl_TSS.bed",
            "ensembl_gene_body": "ensembl_gtf/{genome}_ensembl_gene_body.bed"
            },
        "command_list": [
            "cp {gtf} {asset_outfolder}/{genome}.gtf.gz",
    ...
    "ensembl_rb": {
        "description": "Given a GFF regulatory build file (must be downloaded), create a regulatory annotation asset.",
        "required_inputs": ["gff"],
        "required_assets": [],
        "container": "databio/refgenie",
        "assets": {
            "ensembl_rb": "ensembl_rb/{genome}.gff.gz"
            },
        "command_list": [
    ...
    "refgene_anno": {
        "description": "Given a refGene file (must be downloaded), create gene, TSS, exon, intron, and premature mRNA annotation assets.",
